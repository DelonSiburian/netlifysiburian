...
(function() {
    ...
    var data = {
        ...
        "runtime": [[50, "__cid", [46, "a"], [36, [17, [13, [41, "$0"], [3, "$0", ["require", "getContainerVersion"]], ["$0"]], "containerId"]]], [50, "__e", [46, "a"], [36, [13, [41, "$0"], [3, "$0", ["require", "internal.getEventData"]], ["$0", "event"]]]]
        ],
        "entities": {
            "__cid": {
                "2": true,
...
*/
    ...
    Ki.Ce = Number("0") || 0;
    Ki.ob = "dataLayer";
    Ki.Dn = "ChAIgPW6ugYQ57nr1N2Y3r8xEicA1yD4FIAB0KHFcH5XYh0dJaI4EraH3K0h4nPQAxHJuqCx6Jl9PxwaAq5t";
    var Mi = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    ;var pl;
    try {
        pl = JSON.parse(Ta("eyIwIjoiSUQiLCIxIjoiSUQtSkIiLCIyIjpmYWxzZSwiMyI6Imdvb2dsZS5jby5pZCIsIjQiOiIiLCI1Ijp0cnVlLCI2IjpmYWxzZSwiNyI6ImFkX3N0b3JhZ2V8YW5hbHl0aWNzX3N0b3JhZ2V8YWRfdXNlcl9kYXRhfGFkX3BlcnNvbmFsaXphdGlvbiJ9"))
    } catch (a) {
        V(123),
        ol(2),
        pl = {}
      ...
      , ws = function(a, b, c, d, e) {
        ...
        if (b && c) {
            ...
            for (var f = {
                ...
                Cs(f.adData, d),
                Bs[k.id] = !0) : k && k.prefix === "UA" && !f.gaData && (f.gaData = {
    ...
    ;var IE = function(a, b) {
      ...
      , NE = function(a, b, c) {
        if (!c.isGtmEvent || !KE[a]) {
            var d = !X(O.g.U)
              , e = function(f) {
                var g = "gtm" + String(bj()), k, m = Ax(), n = LE(b, "", c), p, q = n.createOnlyFields._useUp;
                if (c.isGtmEvent || ME(b, n.createOnlyFields)) {
                    ...
                    m(function() {
                        ...
                        n.fieldsToSet["&sst.gcut"] = xh[f]) : (n.fieldsToSend["&gcu"] = "1",
                        n.fieldsToSend["&sst.gcut"] = xh[f]),
                        t.set(n.fieldsToSet),
      ...
      , XE = function(a, b, c) {
        ...
        function e(M) {
            function aa(ia, ea) {
                for (var sa = 0; ea && sa < ea.length; sa++)
                    d(ia, ea[sa])
            }
            var da = c.isGtmEvent
              , U = da ? PE(t) : QE(b, c);
            if (U) {
                ...
                N !== "promo_view" && N !== "impressions" && (aa("ec:addProduct", U.Pc),
                d("ec:setAction", N, U.Ab))
            }
        }
        function f(M) {
            if (M) {
                ...
                if (Uc(M))
                    for (var da in RE)
                        RE.hasOwnProperty(da) && SE(RE[da], da, M[da], aa);
                OE(aa, y);
                d("require", "linkid", aa)
            }
        }
        ...
        function k() {
            ...
            r(function() {
                if (!c.isGtmEvent && Uc(M)) {
                    var aa = t.fieldsToSend, da, U, S = (da = u()) == null ? void 0 : (U = da.getByName) == null ? void 0 : U.call(da, v), N;
                    for (N in M)
        ...
        var p = a, q, r = c.isGtmEvent ? Dx(W(c, "gaFunctionName")) : Dx();
        if (bb(r)) {
            var u = Ax, v;
            c.isGtmEvent ? v = W(c, "name") || W(c, "gtmTrackerName") : v = "gtag_" + p.split("-").join("_");
            var t = LE(v, b, c);
            !c.isGtmEvent && ME(v, t.createOnlyFields) && (r(function() {
                var M, aa;
            ...
            if (b === O.g.ac)
                ...
                NE(p, v, c)) : b === O.g.Ya ? IE(v, c) : b === "screen_view" ? d("send", "screenview", t.fieldsToSend) : b === "timing_complete" ? (t.fieldsToSend.hitType = "timing",
                ...
                m("socialTarget", t.socialTarget, !0)) : ((c.isGtmEvent || VE[b]) && e(y),
                c.isGtmEvent && n(),
      ...
      , QE = function(a, b) {
        ...
        if (Uc(k))
            for (var m = 0; e && m < e.length; ++m) {
                var n = e[m], p;
                for (p in k)
                    k.hasOwnProperty(p) && /^(dimension|metric)\d+$/.test(p) && k[p] != null && TE(n, p, n[k[p]])
            }
        var q = null
          , r = d(O.g.fj);
        if (a === O.g.Ma || a === O.g.zc)
            q = {
                action: a,
                Ab: c(),
                Pc: $E(e)
      ...
      , PE = function(a) {
        ...
        if (b.impressions) {
            ...
            var d = b.impressions;
            c.qk = b.translateIfKeyEquals === "impressions" ? $E(d) : d
        }
        if (b.promoView) {
            c.action = "promo_view";
      ...
      , LE = function(a, b, c) {
        ...
        for (var r = !c.isGtmEvent, u = rm(c), v = 0; v < u.length; ++v) {
            ...
            if (c.isGtmEvent) {
                ...
                if (fF.hasOwnProperty(t))
                    SE(fF[t], t, x, e);
                else if (gF.hasOwnProperty(t))
                    SE(gF[t], t, x, g);
                else if (GE.hasOwnProperty(t))
                    SE(GE[t], t, x, f);
                else if (FE.hasOwnProperty(t))
                    SE(FE[t], t, x, k);
                    ...
                    var A = void 0
                      , C = void 0;
                    b === O.g.ba ? A = Ab(sm(c, t), ".") : (A = Ab(sm(c, t, 1), "."),
                    C = Ab(sm(c, t, 2), "."));
                    A && (f["&gdid"] = A);
                    C && (f["&edid"] = C)
                } else
                    t === O.g.Na && u.indexOf(O.g.Ac) < 0 && (k.cookieName = String(x) + "_ga");
        ...
        if (c.isGtmEvent) {
            ...
            b === "login" || b === "sign_up" || b === "share" ? TE(e, "eventLabel", d(O.g.ah)) : b === "search" || b === "view_search_results" ? TE(e, "eventLabel", d(O.g.wj)) : b === "select_content" && TE(e, "eventLabel", d(O.g.bj));
            var G = e[O.g.xa] || {}
              , J = G[O.g.Hc];
    ...
    oF)
      , pF = {}
      , FE = (pF.client_storage = "storage",
    pF.sample_rate = 1,
    pF.site_speed_sample_rate = 1,
    pF.store_gac = 1,
    pF.use_amp_client_id = 1,
    pF[O.g.tb] = 1,
    pF[O.g.wa] = "storeGac",
    pF[O.g.Ra] = 1,
    pF[O.g.Sa] = 1,
    ...
    qF.cookiePath = 1,
    qF.cookieUpdate = 1,
    qF.legacyCookieDomain = 1,
    qF.legacyHistoryImport = 1,
    qF.name = 1,
    qF.sampleRate = 1,
    qF.siteSpeedSampleRate = 1,
    qF.storage = 1,
    qF.storeGac = 1,
    qF.useAmpClientId = 1,
    qF._cd2l = 1,
    ...
    rF.app_id = 1,
    rF.app_installer_id = 1,
    rF.app_name = 1,
    rF.app_version = 1,
    rF.description = "exDescription",
    rF.fatal = "exFatal",
    rF.language = 1,
    rF.page_hostname = "hostname",
    rF.transport_type = "transport",
    rF[O.g.Ba] = "currencyCode",
    rF[O.g.bh] = 1,
    rF[O.g.ya] = "location",
    rF[O.g.od] = "page",
    rF[O.g.Ga] = "referrer",
    ...
    uF)
      , vF = {}
      , VE = (vF.checkout_progress = 1,
    vF.select_content = 1,
    vF.set_checkout_option = 1,
    vF[O.g.wc] = 1,
    vF[O.g.xc] = 1,
    vF[O.g.Zb] = 1,
    vF[O.g.yc] = 1,
    ...
    vF)
      , wF = {}
      , lF = (wF.checkout_progress = 1,
    wF.set_checkout_option = 1,
    wF[O.g.zg] = 1,
    wF[O.g.Ag] = 1,
    wF[O.g.wc] = 1,
    wF[O.g.xc] = 1,
    ...
    wF)
      , xF = {}
      , mF = (xF.generate_lead = 1,
    xF.login = 1,
    xF.search = 1,
    xF.select_content = 1,
    xF.share = 1,
    xF.sign_up = 1,
    xF.view_search_results = 1,
    xF[O.g.yc] = 1,
    xF[O.g.pb] = 1,
    xF[O.g.Kb] = 1,
    xF[O.g.qb] = 1,
    ...
    function GF() {
        ...
        R(45) && FF ? a = FF : (a.set("containerId", 'UA-132964659-2'),
        a.set("version", '1'),
    ...
    Z.__rep = function(a) {
        var b = uk(a.vtp_containerId), c = Yl(b, !0), d;
        switch (c.prefix) {
        case "AW":
            d = aE;
            break;
        ...
        Zm(b, d),
        a.vtp_remoteConfig && en(b, a.vtp_remoteConfig || {})) : H(a.vtp_gtmOnFailure)
    }
    ,
    Z.__rep.o = "rep",
